<%-- 
    Document   : register
    Created on : Jul 7, 2025, 9:10:28 PM
    Author     : BACH YEN
--%>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h3 class="section-heading signup-header">
                                <span>Tạo</span>
                                <span class="section-heading-pink">tài khoản</span>
                            </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="position-relative mb-5">
                                                <i
                                                    class="bi bi-person-circle position-absolute top-50 start-0 translate-middle-y ms-3 text-muted"></i>
                                                <input type="text" class="form-control ps-5 rounded-pill"
                                                       placeholder="Tên tài khoản" name="username" id="" required>
                                            </div>

                                            <div class="position-relative mb-5">
                                                <i
                                                    class="bi bi-envelope position-absolute top-50 start-0 translate-middle-y ms-3 text-muted"></i>
                                                <input type="email" class="form-control ps-5 rounded-pill"
                                                       placeholder="Email" name="email" id="" required>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="position-relative mb-5">
                                                ...
                                                <input type="password" class="form-control ps-5 rounded-pill"
                                                       placeholder="Mật khẩu" name="password" id="" required>
                                            </div>

                                            <div class="position-relative mb-5">
                                                <i
                                                    class="bi bi-telephone position-absolute top-50 start-0 translate-middle-y ms-3 text-muted"></i>
                                                <input type="text" class="form-control ps-5 rounded-pill"
                                                       placeholder="Số điện thoại" name="phone" id="" required>
                                            </div>
